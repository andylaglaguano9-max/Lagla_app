...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .pill{
      padding:4px 10px;border-radius:999px;border:1px solid var(--line);font-size:12px;color:var(--muted);
  ...
  <div class="container">
    <div class="toolbar">
      <div>
        ...
        <p class="sub">Gestiona roles, estados y accesos del sistema.</p>
      </div>
      <div>
        ...
        <tbody>
          <?php foreach ($usuarios as $u): ?>
            <tr>
              ...
              <td><span class="pill"><?= ($u['Estado'] ?? 0) == 1 ? 'Activo' : 'Inactivo' ?></span></td>
              <td>
                <div class="actions">
                  <a href="../usuarios_editar.php?id=<?= (int)$u['UsuarioId'] ?>">Editar</a>
                  <a href="usuarios.php?eliminar=<?= (int)$u['UsuarioId'] ?>" class="danger">Desactivar</a>
                  <form method="POST" action="../usuarios_borrar.php" style="display:inline;">
                    <input type="hidden" name="usuarioId" value="<?= (int)$u['UsuarioId'] ?>">
